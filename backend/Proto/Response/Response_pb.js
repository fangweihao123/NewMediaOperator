...
var MessageByInitResponseBody_pb = require('./MessageByInitResponseBody_pb.js');
goog.object.extend(proto, MessageByInitResponseBody_pb);
var SendMessageResponseBody_pb = require('./SendMessageResponseBody_pb.js');
goog.object.extend(proto, SendMessageResponseBody_pb);
...
proto.douyin.ResponseBody.toObject = function(includeInstance, msg) {
  var f, obj = {
    sendMessageBody: (f = msg.getSendMessageBody()) && SendMessageResponseBody_pb.SendMessageResponseBody.toObject(includeInstance, f),
    ...
    messageByInit: (f = msg.getMessageByInit()) && MessageByInitResponseBody_pb.MessageByInitResponseBody.toObject(includeInstance, f),
...
proto.douyin.ResponseBody.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 100:
      var value = new SendMessageResponseBody_pb.SendMessageResponseBody;
      reader.readMessage(value,SendMessageResponseBody_pb.SendMessageResponseBody.deserializeBinaryFromReader);
    ...
    case 2018:
      ...
      break;
    case 2043:
      var value = new MessageByInitResponseBody_pb.MessageByInitResponseBody;
      reader.readMessage(value,MessageByInitResponseBody_pb.MessageByInitResponseBody.deserializeBinaryFromReader);
...
proto.douyin.ResponseBody.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      100,
      f,
      SendMessageResponseBody_pb.SendMessageResponseBody.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      2043,
      f,
      MessageByInitResponseBody_pb.MessageByInitResponseBody.serializeBinaryToWriter
    );
  }
...
proto.douyin.ResponseBody.prototype.getSendMessageBody = function() {
  return /** @type{?proto.douyin.SendMessageResponseBody} */ (
    jspb.Message.getWrapperField(this, SendMessageResponseBody_pb.SendMessageResponseBody, 100));
};
...
proto.douyin.ResponseBody.prototype.getMessageByInit = function() {
  return /** @type{?proto.douyin.MessageByInitResponseBody} */ (
    jspb.Message.getWrapperField(this, MessageByInitResponseBody_pb.MessageByInitResponseBody, 2043));
};
